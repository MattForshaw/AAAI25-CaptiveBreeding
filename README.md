...
## Citing this Work
🎉The code repository for "[Constraint optimisation approaches for designing group-living captive breeding programmes](https://ojs.aaai.org/index.php/AAAI/article/view/35016)" (AAAI 2025). If you use any content of this repo for your work, please cite the following bib entry:
